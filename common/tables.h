...
// Temel yapýlarý tutuyoruz çünkü bunlar hala gerekli
...
// JSON yapýsý için yeni item data yapýsý (socket ve attribute bilgileri kaldýrýldý)
...
// DB packet yapýlarý ve enumlarý kaldýrýldý çünkü artýk DB kullanmýyoruz:
// - TPacketGDFakePlayer
// - EFakePlayerGDSubheaders
// - TPacketDGFakePlayer
// - EFakePlayerDGSubheaders
#endif
