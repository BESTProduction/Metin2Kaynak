...
int CInputMain::Whisper(LPCHARACTER ch, const char* data, size_t uiBytes)
{
	...
	{
#ifdef __FAKE_PLAYER__
		if (CFakePlayer* pFakePlayerObj = CFakePlayerManager::Instance().FindFakePlayer(pinfo->szNameTo); pFakePlayerObj)
		{
			LPCHARACTER pFakePlayer = static_cast<LPCHARACTER>(pFakePlayerObj->GetFakePlayer());
			if (pFakePlayer)
			{
				// pFakePlayer ile devam edin
			}
		}
#endif		
		if (ch->GetDesc())
